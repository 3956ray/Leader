...
TID = 'CP2-V8-HOTWORDS-CONSUMER-DECISION-SYNC-001'
BASE = 'bd0bb57efc4348f599c36a3166fa018809914788'
task = json.loads((O / 'tasks' / (TID + '.json')).read_bytes())
allowed = {'AGENTS.md', 'doc/README.md', 'doc/development-guide-v0.1-2026-09-04.md', 'doc/prd-v0.1-2026-09-04.md', 'doc/cp2-v8-hotwords-consumer-route-decision-2026-09-06.md'}
def git(*args):
...
for name in ('AGENTS.md','doc/README.md','doc/development-guide-v0.1-2026-09-04.md'):
    ...
    for url in re.findall(r'\]\(([^)]+)\)',text):
        ...
        links.append(str(q))
    assert 'CP2-ASR-V8-HOTWORDS-IMPL-H-AUTHORIZATION-PREPARATION-001' in text
    assert 'cp2-v8-hotwords-consumer-route-decision-2026-09-06.md' in text
